...
async def catch_all_redirects(full_path: str):
    ...
    # Trailing slash (/) hatana taaki /about-us aur /about-us/ dono ek jaise treat hon
    ...
    # Agar root directory me exact file match ho jaye toh sabse pehle usko serve karo
    if os.path.isfile(requested_path):
        return FileResponse(requested_path)

    # 4. STRICT FOLDER ROUTING (Just like your _redirects file)
    # Ye guarantee dega ki /about-us aur /about-us/ hamesha usi folder ka index.html load karein
    ...
    # Agar na koi root file mili, na hi allowed folder match hua, tab hi Homepage dikhao
    if os.path.exists(CACHED_HTML_PATH):
        with open(CACHED_HTML_PATH, "r", encoding="utf-8") as f:
