...
# --- SEO & Redirect Logic (Replacement for _redirects file) ---
...
async def catch_all_redirects(full_path: str):
    ...
    # 1. Direct File Check (e.g. /favicon.ico, /preview.jpg, /robots.txt, /hshdh.pu)
    if os.path.isfile(requested_path):
        return FileResponse(requested_path)

    # 2. Folder Index Check (e.g. /about-us -> /about-us/index.html)
    ...
    # 3. Agar file ya folder nahi mila toh silently Homepage serve karein (404 ki jagah 200 for SEO)
    if os.path.exists(CACHED_HTML_PATH):
        with open(CACHED_HTML_PATH, "r", encoding="utf-8") as f:
            return HTMLResponse(content=f.read(), status_code=200)
            
    return HTMLResponse("<h1 style='text-align:center; padding-top:50px;'>Optimizing Site...</h1>", status_code=200)
