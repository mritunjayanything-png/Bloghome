...
def generate_static_html():
    ...
    if slider_track:
        ...
        for i, post in enumerate(slider_posts):
            # STRICTLY LOCAL IMAGE HANDLING
            main_img = post['featured_image_path'] if post['featured_image_path'] else '/cache/images/default_feat.webp'
    ...
    if posts_grid:
        ...
        for post in grid_posts:
            ...
            # STRICTLY LOCAL IMAGE HANDLING
            main_img = post['grid_image_path'] if post['grid_image_path'] else '/cache/images/default_grid.webp'
            alt_text = get_alt_text(post['title'])
