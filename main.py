...
def generate_static_html():
    ...
    *, ::before, ::after { box-sizing: border-box; border-width: 0; border-style: solid; border-color: #e5e7eb; }
    ...
    for post in grid_posts:
            ...
            card_html = f"""
            <a href="{FRONTEND_URL}/{post['slug']}" class="glass-list-item rounded-2xl p-4 flex flex-row items-center gap-4 cursor-pointer group animate-fade-in text-inherit no-underline">
